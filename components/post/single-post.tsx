...
export default function SinglePost({ id, title, content, user, image, category, likes, comments, readingTime }: PostsWithUserAndComments) {
    return (
        <>
            ...
            <Card className="flex md:flex-col gap-2 justify-between border-none shadow-none p-3">
                ...
                <RightBar getPosts={() => getRelatedPosts(id, category)} heading="Related posts" />
            </Card>
            <Card>
